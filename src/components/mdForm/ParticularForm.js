...
import { getMutualForm } from "../../actions/user/user";
...
const ParticularForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await dispatch(getMutualForm(id));
        if (res.success) {
          console.log(res)
          setData(res.data[0])
        }
        ...
        <div className="mt-[4.7rem] flex md:mt-0">
          ...
          <div className="md:max-w-auto min-h-screen min-w-0 max-w-full flex-1 rounded-[30px] bg-slate-100 px-4 pb-10 before:block before:h-px before:w-full before:content-[''] dark:bg-darkmode-700 md:px-[22px]">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="h-px my-2 -mx-2 bg-slate-200/60 dark:bg-darkmode-400 bg-white/[0.08]"></div>
                    <button className="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item hover:bg-white/5" onClick={handleLogout}>
            ...
            <div className="card bg-white rounded-lg">
              <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-[4.5rem]">
                <div className="col-span-12">
                  <div>
                    <div className="flex justify-center">
                      <div className="gradient-button lg:w-1/4 xl:w-1/4 sm:w-1/2 text-sm xl:text-[1.2rem] mb-6 sm:mb-12 text-center justify-center font-space-grotesk">
                        He's Details
                      </div>
                    </div>
                    <div className="grid lg:grid-cols-4 xl:grid-cols-4 sm:grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">Name</label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.heDetails?.he_name}
                          </div>
                        </div>
                      </div>

                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          Religion
                        </label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.heDetails?.he_religion}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.heDetails?.he_mobileNumber}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">Email</label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.heDetails?.he_email}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          City Where Husband Belongs to
                        </label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.heDetails?.he_city}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div
                            className="transition duration-200 border shadow-sm py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 text-left disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 dark:border-darkmode-800 dark:bg-darkmode-800"
                            style={{
                              height: "70px",
                              overflowY: "auto",
                            }}
                          >
                            {data?.heDetails?.he_present_address}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          ...
                          >
                            {data?.heDetails?.he_residence_address}
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            {/* She's Details */}
            <div className="card bg-white rounded-lg mt-4">
              <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-[4.5rem]">
                <div className="col-span-12">
                  <div>
                    <div className="flex justify-center">
                    ...
                    <div className="grid lg:grid-cols-4 xl:grid-cols-4 sm:grid-cols-1 md:grid-cols-4 gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.sheDetails?.she_fatherName}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.sheDetails?.she_dateOfBirth}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.sheDetails?.she_mobileNumber}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.sheDetails?.she_email}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          City Where Wife Belongs to
                        </label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.sheDetails?.she_husbandCity}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          ...
                          >
                            {data?.sheDetails?.she_present_address}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          ...
                          >
                            {data?.sheDetails?.she_residence_address}
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="card bg-white rounded-lg mt-4">
              <div className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-[4.5rem]">
                <div className="col-span-12">
                  <div>
                    <div className="gradient-button lg:w-1/4 xl:w-1/4 sm:w-1/4 text-sm xl:text-[1.2rem] mb-6 sm:mb-12 text-center justify-center font-space-grotesk">
                      Required Details
                    </div>
                    ...
                    <div className="grid lg:grid-cols-4 xl:grid-cols-4 sm:grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.otherDetails?.cityOfMarriage}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.otherDetails?.marriage_date}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.otherDetails?.placeOfMarriage}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                          {data?.otherDetails?.doYouHave_children ? "Yes" : "No"}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          Need settlement regarding Maintenance
                        </label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                          {data?.otherDetails?.is_maintenanceAlimony ? "Yes" : "No"}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          Need settlement regarding joint assets
                        </label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                            {data?.otherDetails?.is_settlementRegardingJointAssets ? 'Yes':'No'}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          Any Pending Litigations between the parties?
                        </label>
                        <div className="dropdown relative">
                          <div className="transition duration-200 border shadow-sm items-center py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 hover:bg-opacity-90 hover:border-opacity-90 text-center disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 flex justify-start dark:border-darkmode-800 dark:bg-darkmode-800">
                          {data?.otherDetails?.any_pending_ligitations ? 'Yes':'No'}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          Post Marriage Address
                        </label>
                        <div className="dropdown relative">
                          <div
                            className="transition duration-200 border shadow-sm py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 text-left disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 dark:border-darkmode-800 dark:bg-darkmode-800"
                          ...
                          >
                            {data?.otherDetails?.post_marriage_address}
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-col">
                        <label className="font-space-grotesk mb-2">
                          Any Comment/Remarks For Your Lawyer
                        </label>
                        <div className="dropdown relative">
                          <div
                            className="transition duration-200 border shadow-sm py-2 px-3 rounded-md font-medium cursor-pointer focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus-visible:outline-none dark:focus:ring-slate-700 dark:focus:ring-opacity-50 text-left disabled:opacity-70 disabled:cursor-not-allowed border-secondary text-slate-500 dark:text-slate-300 hover:bg-secondary/20 dark:hover:bg-darkmode-100/10 dark:border-darkmode-800 dark:bg-darkmode-800"
